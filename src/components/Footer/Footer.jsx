...
import LogoImg from "../../assets/all-images/logo-img/LUXARIDE.png";
        ...
        <Row>
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office__info">Al rashidiya, Dubai</p>
              <p className="office__info">Phone: +0995345875365</p>

              <p className="office__info">Email: Luxuride12@gmail.com</p>
          ...
          <Col lg="3" md="4" sm="12">
            <div className="mb-4">
              <h5>  <img src={LogoImg} alt="" className="w-100" /> </h5>
          ...
          <Col lg="12">
            <div className="footer__bottom">
              <p className="section__description d-flex align-items-center justify-content-center gap-1 pt-4">
                ...
                ChrisNaddu. All rights reserved.
              </p>
            </div>
          </Col>
        </Row>
